...
document.querySelector('#update-recipe').addEventListener('click', () => {
    ...
    //store allRecipes into local storage from https://www.w3schools.com/jsref/met_storage_getitem.asp
    saveRecipes(allRecipes)
    //Redirect to home page from https://developer.mozilla.org/en-US/docs/Web/API/Location/assign
